//! Synchronization primitives. See `docs/specs/sync/signal.md`, `docs/specs/sync/spin.md`,
//! `docs/specs/sync/atomic_cell.md`, `docs/specs/sync/raw_spin_lock.md`, `docs/specs/sync/once.md`,
